  ...
  return (
    <div className="accountSetting">
      <div className="accountSetting__info">
        ...
        <div className="accountSetting__info-name">
          {props.currentUser["name"]}
        </div>
        <div className="accountSetting__info-title">
      ...
      <div className="accountSetting__opinion">
        ...
        <div className="accountSetting__opinion-title">Đóng góp ý kiến</div>
      </div>
      <hr className="accountSetting__line" />
      <div className="accountSetting__item">
        ...
        <div
          ...
          className="accountSetting__item-logout"
        >
